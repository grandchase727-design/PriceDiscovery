...
from ml.optimize_params import asset_class_of, DEFAULT_WEIGHTS
from config.scoring import ELIGIBLE_COMPOSITE, ADV_MIN_USD, QVR_GATE
...
def _eligible_ml(r: Dict[str, Any], composite_ml: float, classification_ml: str
    ...
    if composite_ml < ELIGIBLE_COMPOSITE:
