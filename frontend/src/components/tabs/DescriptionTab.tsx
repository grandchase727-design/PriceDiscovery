...
function Section({ title, children, defaultOpen = false, accent }: {
  ...
  return (
    <div className="border border-gray-800 rounded-lg overflow-hidden">
      <button className="w-full px-5 py-3 text-left text-sm font-semibold bg-[#111827] hover:bg-[#1f2937] flex justify-between items-center"
...
export function DescriptionTab() {
  return (
    <div className="space-y-6 max-w-5xl">
      <div>
        <h2 className="text-lg font-bold text-gray-200">System Description</h2>
        <p className="text-xs text-gray-500 mt-1">Price Discovery Scanner v5.0 + Pre-Momentum Detection Multi-Agent Framework</p>
      </div>
      ...
      <div className="border-l-2 border-cyan-500/40 pl-4 mb-2">
        <h3 className="text-sm font-bold text-cyan-400 uppercase tracking-wide">Part 1 — Momentum Detection</h3>
        <p className="text-xs text-gray-500 mt-1">확립된 모멘텀(uptrend) 종목 식별 및 추적 — Price Discovery Scanner v5.0 기반</p>
      </div>
      ...
      <Section title="Signal Architecture — Dual-Timeframe 3-Axis Scoring" defaultOpen accent={C.cyan}>
        ...
        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-cyan-400 mb-2">Composite = 0.35 × TCS + 0.30 × TFS + 0.35 × RSS</div>
          <SigTable
        ...
        <div className="mt-4">
          <div className="text-xs font-semibold text-gray-400 mb-2">TCS (Trend Continuation Score) — 기존 추세의 지속성</div>
          <p className="text-xs text-gray-500">
            이미 형성된 추세가 얼마나 건강하게 유지되고 있는가를 측정합니다.
            SMA20/50/200과의 거리, 기울기, Golden Cross 여부, trend_age(추세 지속 일수)를 기반으로 합니다.
            <strong className="text-gray-300"> Binary→연속 점수 전환</strong>으로 노이즈를 감소시켰습니다. 예: SMA50 위에 있으면 1이 아니라,
            SMA50과의 거리에 따라 ±3% 버퍼 내에서 연속적으로 점수가 변합니다.
          </p>
        </div>

        <div className="mt-3">
          <div className="text-xs font-semibold text-gray-400 mb-2">TFS (Trend Formation Score) — 새로운 추세의 형성</div>
          <p className="text-xs text-gray-500">
        ...
        <div className="mt-3">
          <div className="text-xs font-semibold text-gray-400 mb-2">OER (Overextension Risk) — 과매수 위험</div>
          <p className="text-xs text-gray-500">
        ...
        <div className="mt-3">
          <div className="text-xs font-semibold text-gray-400 mb-2">RSS (Relative Strength Score) — 크로스섹셔널 모멘텀 랭킹</div>
          <p className="text-xs text-gray-500">
      ...
      <Section title="Classification — Dual-Timeframe 3×3 Matrix + Overrides" accent={C.cyan}>
        ...
        <div className="p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-gray-400 mb-2">3×3 Classification Matrix</div>
          <div className="overflow-x-auto">
            <table className="w-full text-xs border-collapse text-center">
              <thead><tr className="border-b border-gray-700">
                <th className="py-1.5 text-gray-500 text-left">Short＼Long</th>
                <th className="py-1.5 text-gray-500">UP</th>
                <th className="py-1.5 text-gray-500">FLAT</th>
                <th className="py-1.5 text-gray-500">DOWN</th>
              </tr></thead>
              <tbody>
                ...
                <tr>
                  ...
                  <td className="py-1.5" style={{color: "#ff8c00"}}>PULLBACK</td>
                  <td className="py-1.5" style={{color: "#dc2626"}}>WEAKENING</td>
        ...
        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-gray-400 mb-2">Overrides (매트릭스 결정 후 적용)</div>
          <SigTable
        ...
        <div className="mt-4 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-gray-300 mb-3">Classification Grouping — Pre-Momentum / Momentum / Excluded</div>
          ...
          {/* Pre-Momentum Group */}
          <div className="mb-4 border-l-2 border-purple-500/40 pl-3">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xs font-bold text-purple-400 uppercase tracking-wide">Pre-Momentum Group</span>
              <span className="text-[10px] text-gray-600">— 모멘텀 형성 이전 단계 (eligible=False AND in 6 PM classes)</span>
            </div>
            <SigTable
          ...
          <div className="mb-4 border-l-2 border-cyan-500/40 pl-3">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xs font-bold text-cyan-400 uppercase tracking-wide">Momentum Group</span>
              <span className="text-[10px] text-gray-600">— 모멘텀 확인 단계 (eligible=True, composite ≥ 55, bullish class)</span>
            </div>
            <SigTable
          ...
          <div className="border-l-2 border-red-500/40 pl-3">
            <div className="flex items-center gap-2 mb-2">
              <span className="text-xs font-bold text-red-400 uppercase tracking-wide">Excluded Group</span>
              <span className="text-[10px] text-gray-600">— 투자 부적격 (bearish or 자격미달)</span>
            </div>
            <SigTable
              headers={["Class", "Short / Long", "의미", "투자 행동"]}
              rows={[
            ...
            <div className="mt-3 text-[10px] text-gray-500">
              <span className="text-gray-400 font-semibold">+ Eligibility 미달 케이스</span> (분류는 Bullish이지만 자격 미달):
      ...
      <Section title="Portfolio Eligibility & Top-10 Selection" accent={C.cyan}>
        <div className="space-y-3">
          <div>
            <div className="text-xs font-semibold text-gray-400 mb-1">Eligibility 조건 (모두 충족)</div>
            <ul className="text-xs text-gray-500 space-y-0.5 list-disc list-inside">
              <li>Classification이 DOWNTREND, EXHAUSTING, FADING, COUNTER_RALLY, CYCLE_PEAK이 <strong className="text-gray-300">아닌</strong> 것</li>
              <li><T>composite ≥ 55</T></li>
              <li><T>ADV ≥ $5M</T> (Average Daily Volume)</li>
            </ul>
          </div>
          <div>
            <div className="text-xs font-semibold text-green-400 mb-1">Top 10 Strong Long 선정</div>
          ...
          <div>
            <div className="text-xs font-semibold text-red-400 mb-1">Bottom 10 Strong Short 선정</div>
            <ol className="text-xs text-gray-500 space-y-0.5 list-decimal list-inside">
      ...
      <Section title="Key Classes & Data Flow" accent={C.cyan}>
        ...
        />
        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg text-xs text-gray-500">
          <div className="text-gray-400 font-semibold mb-1">run_scan() 데이터 플로우</div>
      ...
      <Section title="Universe — ETFs & Stocks" accent={C.cyan}>
        <div className="space-y-3">
          <div>
            <div className="text-xs font-semibold text-gray-400 mb-1">GLOBAL_ETF_UNIVERSE (~231 ETFs, 17 categories)</div>
            <p className="text-xs text-gray-500">
              <strong className="text-gray-300">Equity (7):</strong> US_Equity_Core, US_Sectors, US_Factors, Intl_Developed, Emerging_Markets, Thematic, Korea_Equity<br/>
              <strong className="text-gray-300">FICC (10):</strong> FI_Short(9), FI_Intermediate(8), FI_Long(8), FI_Credit(7), FI_Inflation(5), FI_International(8), Commodities, Real_Assets, Currency_Vol, Multi_Asset
            </p>
          </div>
          <div>
            <div className="text-xs font-semibold text-gray-400 mb-1">STOCK_UNIVERSE (~85+ stocks, 10 GICS-aligned categories)</div>
            <p className="text-xs text-gray-500">
      ...
      <Section title="Core Premise — What is 'Momentum'?" defaultOpen accent={C.cyan}>
        <p className="text-xs text-gray-500">
          Momentum Detection은 <strong className="text-gray-300">현재 상승 추세가 확인된 종목</strong>을 식별하고
          그 추세의 건강도와 지속 기간을 추적합니다.
          Pre-Momentum이 "곧 움직일" 종목을 찾는다면, Momentum은 "이미 움직이고 있는" 종목을 다룹니다.
        </p>

        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg font-mono text-[10px] text-gray-500">
          <div className="text-gray-400 text-xs font-semibold mb-2">Lifecycle</div>
          <div className="flex items-center gap-2 flex-wrap">
            <span className="px-2 py-1 rounded bg-gray-800 text-gray-500">DORMANT</span>
            <span className="text-gray-600">→</span>
            <span className="px-2 py-1 rounded bg-purple-900/30 text-purple-400">PRE-MOMENTUM (Building)</span>
            <span className="text-gray-600">→ 1-3주 →</span>
            <span className="px-2 py-1 rounded bg-cyan-900/30 text-cyan-400">MOMENTUM (Confirmed)</span>
            <span className="text-gray-600">→</span>
            <span className="px-2 py-1 rounded bg-orange-900/30 text-orange-400">CAUTION (Overextended)</span>
            <span className="text-gray-600">→</span>
            <span className="px-2 py-1 rounded bg-red-900/30 text-red-400">EXIT</span>
          </div>
        </div>

        <p className="text-xs text-gray-500 mt-3">
          <strong className="text-gray-300">핵심 설계 철학:</strong> 단일 신호로는 진짜 추세와 거짓 돌파(false breakout)를
          구분하기 어렵습니다. Momentum Detection은 <strong className="text-gray-300">3축 직교 점수(TCS/TFS/RSS) +
      ...
      <Section title="Eligibility — Who Counts as Momentum?" accent={C.cyan}>
        <p className="text-xs text-gray-500">
          Momentum 자격 부여는 <strong className="text-gray-300">3가지 필수 조건</strong>의 동시 충족을 요구합니다.
        </p>

        <div className="mt-3 grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="bg-[#111827] border border-cyan-900/40 rounded-lg p-3">
            <div className="text-xs font-semibold text-cyan-400 mb-2">1. Composite ≥ 55</div>
          ...
          <div className="bg-[#111827] border border-cyan-900/40 rounded-lg p-3">
            <div className="text-xs font-semibold text-cyan-400 mb-2">2. Bullish Classification</div>
            <p className="text-[11px] text-gray-500">
          ...
          <div className="bg-[#111827] border border-cyan-900/40 rounded-lg p-3">
            <div className="text-xs font-semibold text-cyan-400 mb-2">3. ADV ≥ $5M</div>
            <p className="text-[11px] text-gray-500">
        ...
        <div className="mt-4 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-orange-400 mb-2">Override: Overextended → Caution</div>
          <p className="text-[11px] text-gray-500">
            Composite 60+ + Bullish + 정상 ADV 조건을 모두 충족하더라도, OER ≥ 60이면
            <T c={C.yellow}>🟡 OVEREXTENDED</T>로 분류되어 <strong className="text-orange-300">CAUTION 단계</strong>로 격리됩니다.
      ...
      <Section title="Momentum Age — How Long Has the Trend Persisted?" accent={C.cyan}>
        <p className="text-xs text-gray-500">
          Momentum Age는 <strong className="text-gray-300">현재 종목이 확립된 상승 추세에 머물러온 일수</strong>를
          측정합니다. Bi-weekly 관측 데이터(<T>ve_observations</T>, ~14일 간격)를 사용하여
          데일리 노이즈에 영향받지 않고 진정한 구조적 지속성을 산출합니다.
        </p>

        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-cyan-400 mb-3">3-Tier Classification System</div>
          <SigTable
        ...
        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-cyan-400 mb-2">Parameters</div>
          ...
          <div className="mt-2 text-[11px] text-gray-500">
            ...
            현재 Tier A 상태는 <strong className="text-gray-300">today를 1 confirmed로 자동 포함</strong>하여
            최근 재진입 종목도 합리적 age 부여.
          </div>
        </div>

        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-cyan-400 mb-2">Example Walk</div>
          <div className="font-mono text-[10px] text-gray-500 space-y-0.5">
            ...
            <div className="text-cyan-400 mt-1">→ age = today − 1/27 = <strong>~84일</strong></div>
          </div>
        </div>

        <div className="mt-3 grid grid-cols-2 md:grid-cols-5 gap-2">
          <div className="bg-[#111827] border border-gray-800 rounded p-2 text-center">
            <div className="text-[9px] text-gray-500">Color</div>
            <div className="text-[10px] mt-1" style={{ color: C.gray }}>0d (신규)</div>
          </div>
          <div className="bg-[#111827] border border-gray-800 rounded p-2 text-center">
            <div className="text-[9px] text-gray-500">Color</div>
            <div className="text-[10px] mt-1" style={{ color: C.green }}>1-29d (Fresh)</div>
          </div>
          <div className="bg-[#111827] border border-gray-800 rounded p-2 text-center">
            <div className="text-[9px] text-gray-500">Color</div>
            <div className="text-[10px] mt-1" style={{ color: C.cyan }}>30-59d (Mid)</div>
          </div>
          <div className="bg-[#111827] border border-gray-800 rounded p-2 text-center">
            <div className="text-[9px] text-gray-500">Color</div>
            <div className="text-[10px] mt-1" style={{ color: C.orange }}>60-89d (Mature)</div>
          </div>
          <div className="bg-[#111827] border border-gray-800 rounded p-2 text-center">
            <div className="text-[9px] text-gray-500">Color</div>
            <div className="text-[10px] mt-1" style={{ color: C.red }}>≥90d (Aged/Cap)</div>
          </div>
        </div>
      </Section>
      ...
      <Section title="8 Hedge Strategies — Independent Validation Layer" accent={C.cyan}>
        <p className="text-xs text-gray-500">
          단일 시그널 의존을 피하기 위해, 학술/업계에서 검증된 <strong className="text-gray-300">8개 독립 전략</strong>이
        ...
        <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-2">
          {[
            ...
            <div key={s.name} className="bg-[#111827] border border-gray-800 rounded p-2 text-[11px]">
        ...
        <div className="mt-4 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-cyan-400 mb-2">Aggregation</div>
        ...
        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="text-xs font-semibold text-cyan-400 mb-2">Net Signal Classification</div>
          <SigTable
      ...
      <Section title="Multi-Horizon Returns & Volatility" accent={C.cyan}>
        <p className="text-xs text-gray-500">
          단일 horizon이 아닌 <strong className="text-gray-300">9개 시간축 수익률 + 3년 변동성</strong>을 동시 표시하여
        ...
        <div className="mt-3 grid grid-cols-3 md:grid-cols-5 gap-2">
          {[
            ...
            <div key={k} className="bg-[#111827] border border-gray-800 rounded p-2 text-center">
              <div className="text-[11px] font-semibold text-cyan-400">{k}</div>
              <div className="text-[10px] text-gray-500 mt-0.5">{v}</div>
            </div>
          ))}
        </div>

        <p className="text-[11px] text-gray-500 mt-3">
          <strong className="text-gray-300">활용 예시:</strong> 1D/1W는 진입 타이밍, 1M-6M는 추세 강도 확인,
      ...
      <Section title="Output — How Momentum Tickers Surface in the Dashboard" accent={C.cyan}>
        ...
        <div className="mt-3 space-y-2">
          {[
            ...
            <div key={s.label} className="flex gap-3 text-[11px] p-2 bg-[#111827] border border-gray-800 rounded">
              <div className="text-cyan-400 font-semibold w-48 shrink-0">{s.label}</div>
      ...
      <div className="border-l-2 border-purple-500/40 pl-4 mt-8 mb-2">
        <h3 className="text-sm font-bold text-purple-400 uppercase tracking-wide">Part 2 — Pre-Momentum Detection</h3>
        <p className="text-xs text-gray-500 mt-1">Multi-Agent Framework: 모멘텀 형성 이전 구조적 전조를 포착</p>
      </div>

      {/* Core Premise */}
      <Section title="Core Premise — Why Pre-Momentum?" defaultOpen accent={C.purple}>
        <p className="text-xs text-gray-500">
          Price Discovery(PD)는 <strong className="text-gray-300">모멘텀이 이미 형성된 후</strong> 이를 측정합니다
          (TCS/TFS/RSS → Composite → CONTINUATION/FORMATION).
          Pre-Momentum Detection은 그 <strong className="text-gray-300">이전 단계</strong> —
          아직 모멘텀으로 분류되지 않았지만 구조적 전조가 보이는 종목을 포착합니다.
        </p>

        <div className="mt-3 p-3 bg-[#111827] border border-gray-800 rounded-lg font-mono text-[10px] text-gray-500">
          <div className="text-gray-400 text-xs font-semibold mb-2">Timeline</div>
          <div className="flex items-center gap-2 flex-wrap">
            <span className="px-2 py-1 rounded bg-purple-900/30 text-purple-400">Pre-Momentum Detection</span>
            <span className="text-gray-600">→ 1-3주 →</span>
            <span className="px-2 py-1 rounded bg-cyan-900/30 text-cyan-400">PD: FORMATION/RECOVERY</span>
            <span className="text-gray-600">→</span>
            <span className="px-2 py-1 rounded bg-green-900/30 text-green-400">PD: CONTINUATION</span>
            <span className="text-gray-600">→</span>
            <span className="px-2 py-1 rounded bg-green-900/30 text-green-300">Portfolio 편입</span>
          </div>
        </div>

        <p className="text-xs text-gray-500 mt-3">
          <strong className="text-gray-300">핵심 설계 철학:</strong> 단일 시그널로는 노이즈와 구분이 안 됩니다.
          서로 다른 정보원(가격 구조, 매크로, 네트워크, 전략 컨센서스)에서 독립적으로
          "뭔가 변하고 있다"는 약한 신호들이 <strong className="text-gray-300">동시에 수렴</strong>할 때 —
          그것이 모멘텀 형성의 전조입니다.
        </p>
      </Section>
      ...
      <Section title="Step 1 — Universe Filtering" accent={C.purple}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="p-3 bg-[#111827] border border-gray-800 rounded-lg">
            <div className="text-xs font-semibold text-red-400 mb-1">제외 (이미 모멘텀 or 극단)</div>
          ...
          <div className="p-3 bg-[#111827] border border-gray-800 rounded-lg">
            <div className="text-xs font-semibold text-green-400 mb-1">포함 (Pre-Momentum 대상)</div>
            <ul className="text-[11px] text-gray-500 space-y-0.5">
              <li><strong className="text-gray-300">RECOVERY</strong> — 장기 하락 후 단기 반등 시작</li>
              <li><strong className="text-gray-300">NEUTRAL</strong> — 방향성 미정, 어디로든</li>
              <li><strong className="text-gray-300">FADING</strong> — 추세 약화지만 반전 가능</li>
              <li><strong className="text-gray-300">CONSOLIDATION</strong> — 횡보, 에너지 축적</li>
              <li><strong className="text-gray-300">WEAKENING</strong> — 약세지만 바닥 근접 가능</li>
              <li><strong className="text-gray-300">PULLBACK</strong> — 건전한 조정</li>
            </ul>
          </div>
        </div>
      </Section>
      ...
      <Section title="Step 2 — 4 Independent Specialist Agents" defaultOpen accent={C.purple}>
        ...
        <div className="p-4 bg-[#111827] border border-gray-800 rounded-lg space-y-3">
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold" style={{color: C.cyan}}>Agent 1: Microstructure</span>
            <span className="text-[10px] px-1.5 py-0.5 rounded font-semibold bg-blue-900/30 text-blue-400">Quant</span>
            <span className="text-[10px] text-gray-500">Weight: 30%</span>
          </div>
          <p className="text-xs text-gray-500">"가격은 안 움직였지만, <strong className="text-gray-300">구조</strong>가 변하고 있는가?"</p>
          <SigTable
          ...
          />
          <p className="text-[10px] text-gray-600">가중치: vol_compression 25%, accumulation 25%, structural_div 20%, volume 15%, range 15%</p>
        </div>

        {/* Agent 2: Macro Regime */}
        <div className="p-4 bg-[#111827] border border-gray-800 rounded-lg space-y-3 mt-4">
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold" style={{color: C.blue}}>Agent 2: Macro Regime</span>
            <span className="text-[10px] px-1.5 py-0.5 rounded font-semibold bg-blue-900/30 text-blue-400">Quant</span>
            <span className="text-[10px] text-gray-500">Weight: 20%</span>
          </div>
          <p className="text-xs text-gray-500">"이 종목의 <strong className="text-gray-300">섹터/매크로 환경</strong>이 우호적으로 전환되고 있는가?"</p>
          <SigTable
            headers={["Sub-Signal", "산출 로직", "의미"]}
            rows={[
          ...
          />
          <p className="text-[10px] text-gray-600">가중치: sector_rotation 30%, cross_asset 20%, breadth 25%, improvement 25%</p>
        </div>

        {/* Agent 3: Graph Relational */}
        <div className="p-4 bg-[#111827] border border-gray-800 rounded-lg space-y-3 mt-4">
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold" style={{color: C.purple}}>Agent 3: Graph Relational</span>
            <span className="text-[10px] px-1.5 py-0.5 rounded font-semibold bg-purple-900/30 text-purple-400">Hybrid</span>
            <span className="text-[10px] text-gray-500">Weight: 25%</span>
          </div>
          <p className="text-xs text-gray-500">"<strong className="text-gray-300">연관 종목/테마</strong>에서 이미 모멘텀이 시작되었는가? 전이 가능성은?"</p>
          <SigTable
            headers={["Sub-Signal", "산출 로직", "의미"]}
            rows={[
          ...
          />
          <p className="text-[10px] text-gray-600">가중치: peer_lead 30%, theme_breadth 25%, leader_lagger 25%, community 20%. ETF는 테마 매핑이 없어 peer signal 약함</p>
        </div>

        {/* Agent 4: Catalyst */}
        <div className="p-4 bg-[#111827] border border-gray-800 rounded-lg space-y-3 mt-4">
          <div className="flex items-center gap-2">
            <span className="text-sm font-bold" style={{color: C.orange}}>Agent 4: Catalyst Proxy</span>
            <span className="text-[10px] px-1.5 py-0.5 rounded font-semibold bg-blue-900/30 text-blue-400">Quant</span>
            <span className="text-[10px] text-gray-500">Weight: 25%</span>
          </div>
          <p className="text-xs text-gray-500">"모멘텀 <strong className="text-gray-300">가속</strong>의 초기 신호가 있는가?"</p>
          <SigTable
            headers={["Sub-Signal", "산출 로직", "의미"]}
            rows={[
          ...
          />
          <p className="text-[10px] text-gray-600">가중치: momentum_accel 30%, strategy_agreement 25%, trajectory 30%, reversal_risk 15%</p>
        </div>
      </Section>

      {/* Step 3: Orchestrator */}
      <Section title="Step 3 — Orchestrator: Agreement & Conviction" accent={C.purple}>
        <div className="p-3 bg-[#111827] border border-gray-800 rounded-lg mb-3">
          <div className="text-xs font-semibold text-purple-400 mb-2">Final Score</div>
          <div className="font-mono text-sm text-gray-300">
            Pre-Momentum Score = Micro × <span className="text-cyan-400">0.30</span> + Macro × <span className="text-blue-400">0.20</span> + Graph × <span className="text-purple-400">0.25</span> + Catalyst × <span className="text-orange-400">0.25</span>
          </div>
        </div>

        <p className="text-xs text-gray-500 mb-3">
          각 에이전트가 <strong className="text-gray-300">독립적으로 50점을 넘기는지</strong> 카운트하여 Conviction을 결정합니다.
      ...
      <Section title="Step 4 — Catalyst & Risk Extraction" accent={C.purple}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="p-3 bg-[#111827] border border-gray-800 rounded-lg">
            <div className="text-xs font-semibold text-green-400 mb-2">Catalyst 추출 조건</div>
            <ul className="text-[11px] text-gray-500 space-y-1">
              <li><span className="text-gray-400">Micro:</span> vol_compression ≥ 65 → "Coiled spring setup"</li>
              <li><span className="text-gray-400">Micro:</span> accumulation ≥ 55 → "Early accumulation"</li>
              <li><span className="text-gray-400">Macro:</span> sector_rotation ≥ 60 → "Sector rotation favorable"</li>
              <li><span className="text-gray-400">Macro:</span> breadth ≥ 65 → "Category breadth expanding"</li>
              <li><span className="text-gray-400">Graph:</span> peer_lead ≥ 55 → "Peers in CONTINUATION" (종목명 포함)</li>
              <li><span className="text-gray-400">Graph:</span> leader_gap ≥ 60 → "Catch-up potential"</li>
              <li><span className="text-gray-400">Catalyst:</span> trajectory ≥ 55 → "Score trajectory accelerating"</li>
              <li><span className="text-gray-400">Catalyst:</span> strategy ≥ 60 → "Multiple strategies turning long"</li>
            </ul>
          </div>
          <div className="p-3 bg-[#111827] border border-gray-800 rounded-lg">
            <div className="text-xs font-semibold text-red-400 mb-2">Risk 추출 조건</div>
            <ul className="text-[11px] text-gray-500 space-y-1">
        ...
        <div className="p-4 bg-[#111827] border border-gray-800 rounded-lg">
          <div className="space-y-3 text-xs">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-purple-900/40 flex items-center justify-center text-purple-400 font-bold text-sm shrink-0">1</div>
              <div>
                <div className="text-gray-300 font-semibold">Pre-Momentum HIGH conviction 감지</div>
                <div className="text-gray-500">아직 PD 점수는 낮지만 구조적 전조가 수렴 (NEUTRAL/CONSOLIDATION/RECOVERY)</div>
              </div>
            </div>
            <div className="border-l border-gray-700 ml-4 h-4"></div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-blue-900/40 flex items-center justify-center text-blue-400 font-bold text-sm shrink-0">2</div>
              <div>
                <div className="text-gray-300 font-semibold">PD에서 FORMATION / RECOVERY 감지 (1-3주 후)</div>
                <div className="text-gray-500">TFS_short 상승, 단기 돌파 시작. Pre-Momentum 신호가 현실화</div>
              </div>
            </div>
            <div className="border-l border-gray-700 ml-4 h-4"></div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-cyan-900/40 flex items-center justify-center text-cyan-400 font-bold text-sm shrink-0">3</div>
              <div>
                <div className="text-gray-300 font-semibold">PD에서 CONTINUATION 확인</div>
                <div className="text-gray-500">TCS 상승, 장기 추세 확인. Composite ≥ 55, eligible = True</div>
              </div>
            </div>
            <div className="border-l border-gray-700 ml-4 h-4"></div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-green-900/40 flex items-center justify-center text-green-400 font-bold text-sm shrink-0">4</div>
              <div>
                <div className="text-gray-300 font-semibold">Portfolio 편입</div>
                <div className="text-gray-500">Top 10 Strong Long 선정, 8개 전략 컨센서스 확인</div>
              </div>
            </div>
          </div>
        </div>
